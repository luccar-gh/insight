...
const organizations = [
    ...
    {
        name: "Dansk Blindesamfund (DBS)",
        fullName: "Dansk Blindesamfund",
        fullNameEn: "Danish Association of the Blind",
        desc: "Rettigheds- og medlemsdrevet organisation med 7.500+ medlemmer. Kæmper for fuld inklusion og deltagelse i alle aspekter af samfundet. Certificeret leverandør af førerhunde.",
        descEn: "Rights-based, member-driven organization with 7,500+ members. Advocates for full inclusion and participation in all aspects of society. Certified guide dog provider.",
        members: "7,500+",
        founded: "1911",
        location: "København",
        url: "blind.dk",
